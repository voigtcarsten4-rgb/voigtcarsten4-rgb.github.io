/* =====================================================================
   BELL FASTLANE — Premium Motion Layer (motion.js)  v10
   ===================================================================== */
(function () {
  'use strict';
  ...
  function injectStyle() {
    ...
    var css = ''
      // ---- v10 Lesbarkeit: dunklere Tokens für kleine Texte (Kontrast) ----
      + ':root{--ink-3:#6E655E;--warn:#9A6B00;--st-prep:#B5790A}'
      ...
      + '.fl-advantage b{display:block;font-size:var(--fs-sm);color:#8A4300}.fl-advantage span{display:block;font-size:var(--fs-xs);color:#9A5512;line-height:1.4}'
      ...
      + '.bell-pass .bp-sub{font-size:11px;color:rgba(255,255,255,.78);line-height:1.35}'
      ...
      + '.tk-meta{font-size:12px;font-weight:700;color:var(--ink-2);background:var(--surface-2);border:1px solid var(--line);border-radius:8px;padding:5px 9px;margin:2px 0 6px}'
      ...
      + '.live-url-chip{display:inline-flex;align-items:center;gap:7px;font-size:var(--fs-xs);font-weight:700;color:var(--ink-2);background:var(--surface-2);border:1px solid var(--line);border-radius:999px;padding:6px 12px;word-break:break-all}'
      ...
      + '.bon-r-foot{margin:6px 16px 12px;padding:11px;border-radius:12px;text-align:center;font-weight:800;font-size:13px;background:#FFF1DE;color:#8A5A00}'
      ...
      + '.bon-tag{display:inline-flex;align-items:center;gap:5px;font-size:11px;font-weight:800;padding:3px 9px;border-radius:999px;background:#FFF1DE;color:#8A5A00}'
      ...
      + '.perso-inp{width:100%;border:1px solid var(--line-2);border-radius:12px;padding:11px 13px;font-size:var(--fs-md);background:#fff;outline:none;color:var(--ink)}'
      ...
      + '.chip-when{flex:1;border:1px solid var(--line-2);background:#fff;border-radius:12px;padding:9px;font-weight:700;font-size:var(--fs-sm);color:var(--ink-2);cursor:pointer;transition:all .15s}'
      ...
      + '.bw-sub{display:block;font-size:12px;opacity:.92;margin-top:4px;letter-spacing:.05em;text-transform:uppercase}'
